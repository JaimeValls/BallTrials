...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=9812f49';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=9812f49';
import { createFx } from '../chassis/sfx.mjs?v=9812f49';
import { FPS } from './sim.js?v=9812f49';
