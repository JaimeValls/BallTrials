...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=21012f2';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=21012f2';
import { createFx } from '../chassis/sfx.mjs?v=21012f2';
import { FPS } from './sim.js?v=21012f2';
