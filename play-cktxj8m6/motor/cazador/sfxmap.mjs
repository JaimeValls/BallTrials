...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=71c81de';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=71c81de';
import { createFx } from '../chassis/sfx.mjs?v=71c81de';
import { FPS } from './sim.js?v=71c81de';
