...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=227bccc-SUCIO';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=227bccc-SUCIO';
import { createFx } from '../chassis/sfx.mjs?v=227bccc-SUCIO';
import { FPS } from './sim.js?v=227bccc-SUCIO';
