...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=037a45d';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=037a45d';
import { createFx } from '../chassis/sfx.mjs?v=037a45d';
import { FPS } from './sim.js?v=037a45d';
