...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=edadccb';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=edadccb';
import { createFx } from '../chassis/sfx.mjs?v=edadccb';
import { FPS } from './sim.js?v=edadccb';
