...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=cbd3856';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=cbd3856';
import { createFx } from '../chassis/sfx.mjs?v=cbd3856';
import { FPS } from './sim.js?v=cbd3856';
