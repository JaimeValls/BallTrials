...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=7715590';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=7715590';
import { createFx } from '../chassis/sfx.mjs?v=7715590';
import { FPS } from './sim.js?v=7715590';
