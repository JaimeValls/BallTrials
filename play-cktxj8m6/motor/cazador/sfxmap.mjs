...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=fc9c665';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=fc9c665';
import { createFx } from '../chassis/sfx.mjs?v=fc9c665';
import { FPS } from './sim.js?v=fc9c665';
