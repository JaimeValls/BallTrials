...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=266d6f0';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=266d6f0';
import { createFx } from '../chassis/sfx.mjs?v=266d6f0';
import { FPS } from './sim.js?v=266d6f0';
