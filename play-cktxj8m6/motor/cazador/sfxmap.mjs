...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=17fbbac';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=17fbbac';
import { createFx } from '../chassis/sfx.mjs?v=17fbbac';
import { FPS } from './sim.js?v=17fbbac';
