...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=02d4b27';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=02d4b27';
import { createFx } from '../chassis/sfx.mjs?v=02d4b27';
import { FPS } from './sim.js?v=02d4b27';
