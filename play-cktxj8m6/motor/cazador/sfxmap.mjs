...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=780b34b';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=780b34b';
import { createFx } from '../chassis/sfx.mjs?v=780b34b';
import { FPS } from './sim.js?v=780b34b';
