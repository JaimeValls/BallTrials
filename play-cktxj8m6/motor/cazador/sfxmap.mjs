...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=5d37c9e';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=5d37c9e';
import { createFx } from '../chassis/sfx.mjs?v=5d37c9e';
import { FPS } from './sim.js?v=5d37c9e';
