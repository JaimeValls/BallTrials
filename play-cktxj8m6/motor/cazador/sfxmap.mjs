...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=2a79017';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=2a79017';
import { createFx } from '../chassis/sfx.mjs?v=2a79017';
import { FPS } from './sim.js?v=2a79017';
