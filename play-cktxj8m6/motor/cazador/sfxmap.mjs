...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=b51eaf3';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=b51eaf3';
import { createFx } from '../chassis/sfx.mjs?v=b51eaf3';
import { FPS } from './sim.js?v=b51eaf3';
