...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=49450b6';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=49450b6';
import { createFx } from '../chassis/sfx.mjs?v=49450b6';
import { FPS } from './sim.js?v=49450b6';
