...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=66a6e7a';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=66a6e7a';
import { createFx } from '../chassis/sfx.mjs?v=66a6e7a';
import { FPS } from './sim.js?v=66a6e7a';
