...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=d84768d';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=d84768d';
import { createFx } from '../chassis/sfx.mjs?v=d84768d';
import { FPS } from './sim.js?v=d84768d';
