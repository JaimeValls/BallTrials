...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=13a794a';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=13a794a';
import { createFx } from '../chassis/sfx.mjs?v=13a794a';
import { FPS } from './sim.js?v=13a794a';
