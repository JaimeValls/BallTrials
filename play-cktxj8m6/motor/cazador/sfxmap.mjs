...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=9ebbeab';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=9ebbeab';
import { createFx } from '../chassis/sfx.mjs?v=9ebbeab';
import { FPS } from './sim.js?v=9ebbeab';
