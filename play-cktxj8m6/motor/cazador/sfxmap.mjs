...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=689c6e8';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=689c6e8';
import { createFx } from '../chassis/sfx.mjs?v=689c6e8';
import { FPS } from './sim.js?v=689c6e8';
