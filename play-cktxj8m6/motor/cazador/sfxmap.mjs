...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=ade307c';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=ade307c';
import { createFx } from '../chassis/sfx.mjs?v=ade307c';
import { FPS } from './sim.js?v=ade307c';
