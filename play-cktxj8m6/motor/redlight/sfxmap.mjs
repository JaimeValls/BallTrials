...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=f5b831c';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=f5b831c';
import { createFx } from '../chassis/sfx.mjs?v=f5b831c';
import { FPS } from './sim.js?v=f5b831c';
