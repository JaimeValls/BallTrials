...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=d17deb4';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=d17deb4';
import { createFx } from '../chassis/sfx.mjs?v=d17deb4';
import { FPS } from './sim.js?v=d17deb4';
