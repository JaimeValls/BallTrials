...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=5acdb92';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=5acdb92';
import { createFx } from '../chassis/sfx.mjs?v=5acdb92';
import { FPS } from './sim.js?v=5acdb92';
