...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=99ccfb4';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=99ccfb4';
import { createFx } from '../chassis/sfx.mjs?v=99ccfb4';
import { FPS } from './sim.js?v=99ccfb4';
