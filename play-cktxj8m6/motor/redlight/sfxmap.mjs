...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=60055fe';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=60055fe';
import { createFx } from '../chassis/sfx.mjs?v=60055fe';
import { FPS } from './sim.js?v=60055fe';
