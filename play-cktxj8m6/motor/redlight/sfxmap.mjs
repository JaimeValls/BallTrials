...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=7565afb';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=7565afb';
import { createFx } from '../chassis/sfx.mjs?v=7565afb';
import { FPS } from './sim.js?v=7565afb';
