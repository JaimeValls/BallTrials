...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=be8192a';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=be8192a';
import { createFx } from '../chassis/sfx.mjs?v=be8192a';
import { FPS } from './sim.js?v=be8192a';
