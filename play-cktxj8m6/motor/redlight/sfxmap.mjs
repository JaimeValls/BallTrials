...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=f84dd55';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=f84dd55';
import { createFx } from '../chassis/sfx.mjs?v=f84dd55';
import { FPS } from './sim.js?v=f84dd55';
