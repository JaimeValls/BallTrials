...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=d63db61';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=d63db61';
import { createFx } from '../chassis/sfx.mjs?v=d63db61';
import { FPS } from './sim.js?v=d63db61';
