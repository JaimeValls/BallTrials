...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=8e2eab0';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=8e2eab0';
import { createFx } from '../chassis/sfx.mjs?v=8e2eab0';
import { FPS } from './sim.js?v=8e2eab0';
