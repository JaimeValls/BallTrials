...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=68577ac';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=68577ac';
import { createFx } from '../chassis/sfx.mjs?v=68577ac';
import { FPS } from './sim.js?v=68577ac';
