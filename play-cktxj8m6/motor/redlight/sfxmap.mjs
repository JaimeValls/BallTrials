...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=2dbddba';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=2dbddba';
import { createFx } from '../chassis/sfx.mjs?v=2dbddba';
import { FPS } from './sim.js?v=2dbddba';
