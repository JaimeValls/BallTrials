...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=1886b29';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=1886b29';
import { createFx } from '../chassis/sfx.mjs?v=1886b29';
import { FPS } from './sim.js?v=1886b29';
