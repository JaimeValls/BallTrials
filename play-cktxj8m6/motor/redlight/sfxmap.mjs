...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=21828dc';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=21828dc';
import { createFx } from '../chassis/sfx.mjs?v=21828dc';
import { FPS } from './sim.js?v=21828dc';
