...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=f74d8ee';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=f74d8ee';
import { createFx } from '../chassis/sfx.mjs?v=f74d8ee';
import { FPS } from './sim.js?v=f74d8ee';
