...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=663c9be';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=663c9be';
import { createFx } from '../chassis/sfx.mjs?v=663c9be';
import { FPS } from './sim.js?v=663c9be';
