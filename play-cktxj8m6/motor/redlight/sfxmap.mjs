...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=f1683e3';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=f1683e3';
import { createFx } from '../chassis/sfx.mjs?v=f1683e3';
import { FPS } from './sim.js?v=f1683e3';
