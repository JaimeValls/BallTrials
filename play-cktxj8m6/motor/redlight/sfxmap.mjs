...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=77712da';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=77712da';
import { createFx } from '../chassis/sfx.mjs?v=77712da';
import { FPS } from './sim.js?v=77712da';
