...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=0b61007';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=0b61007';
import { createFx } from '../chassis/sfx.mjs?v=0b61007';
import { FPS } from './sim.js?v=0b61007';
