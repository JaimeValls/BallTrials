...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=aa6ce8c';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=aa6ce8c';
import { createFx } from '../chassis/sfx.mjs?v=aa6ce8c';
import { FPS } from './sim.js?v=aa6ce8c';
