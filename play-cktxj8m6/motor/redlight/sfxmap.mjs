...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=26588e1';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=26588e1';
import { createFx } from '../chassis/sfx.mjs?v=26588e1';
import { FPS } from './sim.js?v=26588e1';
