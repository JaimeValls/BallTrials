...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=da5637b';
...
import { createSynth, makeRng } from '../chassis/synth.mjs?v=da5637b';
import { createFx } from '../chassis/sfx.mjs?v=da5637b';
import { FPS } from './sim.js?v=da5637b';
