...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=e45be05';
import { PAUSA } from './pausa.mjs?v=e45be05';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
