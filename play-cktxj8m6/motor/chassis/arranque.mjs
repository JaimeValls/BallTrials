...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=039b592';
import { PAUSA } from './pausa.mjs?v=039b592';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
