...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=f55ae74';
import { PAUSA } from './pausa.mjs?v=f55ae74';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
