...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=fc9c665';
import { PAUSA } from './pausa.mjs?v=fc9c665';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
