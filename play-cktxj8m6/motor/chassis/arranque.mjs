...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=b812e3b';
import { PAUSA } from './pausa.mjs?v=b812e3b';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
