...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=21012f2';
import { PAUSA } from './pausa.mjs?v=21012f2';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
