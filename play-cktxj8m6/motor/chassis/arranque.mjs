...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=b81cd26';
import { PAUSA } from './pausa.mjs?v=b81cd26';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
