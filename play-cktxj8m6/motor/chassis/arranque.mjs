...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=726b446';
import { PAUSA } from './pausa.mjs?v=726b446';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
