...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=6acb13c';
import { PAUSA } from './pausa.mjs?v=6acb13c';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
