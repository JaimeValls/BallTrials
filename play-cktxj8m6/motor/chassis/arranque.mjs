...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=797ae79';
import { PAUSA } from './pausa.mjs?v=797ae79';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
