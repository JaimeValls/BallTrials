...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=1886b29';
import { PAUSA } from './pausa.mjs?v=1886b29';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
