...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=68cd758';
import { PAUSA } from './pausa.mjs?v=68cd758';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
