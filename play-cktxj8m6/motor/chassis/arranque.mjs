...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=780b34b';
import { PAUSA } from './pausa.mjs?v=780b34b';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
