...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=ade307c';
import { PAUSA } from './pausa.mjs?v=ade307c';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
