...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=d63db61';
import { PAUSA } from './pausa.mjs?v=d63db61';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
