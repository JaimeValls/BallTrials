...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=21828dc';
import { PAUSA } from './pausa.mjs?v=21828dc';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
