...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=62f566e';
import { PAUSA } from './pausa.mjs?v=62f566e';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
