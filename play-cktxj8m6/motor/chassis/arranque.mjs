...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=2a5528f';
import { PAUSA } from './pausa.mjs?v=2a5528f';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
