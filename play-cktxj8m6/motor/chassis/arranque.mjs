...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=7565afb';
import { PAUSA } from './pausa.mjs?v=7565afb';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
