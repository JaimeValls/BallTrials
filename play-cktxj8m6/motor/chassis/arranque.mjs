...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=32fe509';
import { PAUSA } from './pausa.mjs?v=32fe509';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
