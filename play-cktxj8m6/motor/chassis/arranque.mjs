...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=05e5c3d';
import { PAUSA } from './pausa.mjs?v=05e5c3d';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
