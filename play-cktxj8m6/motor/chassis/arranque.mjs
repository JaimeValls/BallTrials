...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=68577ac';
import { PAUSA } from './pausa.mjs?v=68577ac';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
