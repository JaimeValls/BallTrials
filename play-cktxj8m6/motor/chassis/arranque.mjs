...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=1687de6';
import { PAUSA } from './pausa.mjs?v=1687de6';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
