...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=66a6e7a';
import { PAUSA } from './pausa.mjs?v=66a6e7a';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
