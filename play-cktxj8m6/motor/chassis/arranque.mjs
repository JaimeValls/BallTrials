...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=edadccb';
import { PAUSA } from './pausa.mjs?v=edadccb';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
