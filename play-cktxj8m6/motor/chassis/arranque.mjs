...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=724fcf0';
import { PAUSA } from './pausa.mjs?v=724fcf0';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
