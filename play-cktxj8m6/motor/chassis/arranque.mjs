...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=58b9007';
import { PAUSA } from './pausa.mjs?v=58b9007';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
