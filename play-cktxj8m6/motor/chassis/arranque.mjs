...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=9d83055';
import { PAUSA } from './pausa.mjs?v=9d83055';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
