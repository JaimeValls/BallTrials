...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=ac3c8c1-SUCIO';
import { PAUSA } from './pausa.mjs?v=ac3c8c1-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
