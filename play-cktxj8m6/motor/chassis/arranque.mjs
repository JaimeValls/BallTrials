...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=6855491';
import { PAUSA } from './pausa.mjs?v=6855491';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
