...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=0c4584d';
import { PAUSA } from './pausa.mjs?v=0c4584d';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
