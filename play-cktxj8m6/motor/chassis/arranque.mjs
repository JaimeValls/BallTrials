...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=02d4b27';
import { PAUSA } from './pausa.mjs?v=02d4b27';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
