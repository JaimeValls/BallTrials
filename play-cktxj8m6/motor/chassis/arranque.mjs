...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=689c6e8';
import { PAUSA } from './pausa.mjs?v=689c6e8';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
