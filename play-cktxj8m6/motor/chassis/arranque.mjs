...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=7777f97';
import { PAUSA } from './pausa.mjs?v=7777f97';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
