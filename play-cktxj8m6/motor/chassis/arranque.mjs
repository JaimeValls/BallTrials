...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=1763a13';
import { PAUSA } from './pausa.mjs?v=1763a13';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
