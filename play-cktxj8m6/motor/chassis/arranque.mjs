...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=2dbddba';
import { PAUSA } from './pausa.mjs?v=2dbddba';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
