...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=54f3e58';
import { PAUSA } from './pausa.mjs?v=54f3e58';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
