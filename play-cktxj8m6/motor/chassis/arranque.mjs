...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=95bdd8d-SUCIO';
import { PAUSA } from './pausa.mjs?v=95bdd8d-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
