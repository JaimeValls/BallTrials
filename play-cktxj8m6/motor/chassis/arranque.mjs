...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=cb18883';
import { PAUSA } from './pausa.mjs?v=cb18883';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
