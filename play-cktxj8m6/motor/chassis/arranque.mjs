...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=f5b831c';
import { PAUSA } from './pausa.mjs?v=f5b831c';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
