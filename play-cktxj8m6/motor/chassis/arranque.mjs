...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=f1c5101';
import { PAUSA } from './pausa.mjs?v=f1c5101';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
