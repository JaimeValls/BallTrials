...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=37af923';
import { PAUSA } from './pausa.mjs?v=37af923';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
