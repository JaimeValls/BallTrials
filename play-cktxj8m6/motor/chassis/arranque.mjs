...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=6855491-SUCIO';
import { PAUSA } from './pausa.mjs?v=6855491-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
