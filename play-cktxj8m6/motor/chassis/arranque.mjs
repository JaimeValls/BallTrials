...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=7334418';
import { PAUSA } from './pausa.mjs?v=7334418';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
