...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=ab3d86c';
import { PAUSA } from './pausa.mjs?v=ab3d86c';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
