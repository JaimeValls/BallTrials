...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=7c5169e-SUCIO';
import { PAUSA } from './pausa.mjs?v=7c5169e-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
