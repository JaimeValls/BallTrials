...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=96ca7c9';
import { PAUSA } from './pausa.mjs?v=96ca7c9';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
