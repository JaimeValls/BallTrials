...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=82904ad';
import { PAUSA } from './pausa.mjs?v=82904ad';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
