...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=49450b6';
import { PAUSA } from './pausa.mjs?v=49450b6';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
