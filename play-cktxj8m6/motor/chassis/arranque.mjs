...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=037a45d';
import { PAUSA } from './pausa.mjs?v=037a45d';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
