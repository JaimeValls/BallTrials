...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=1b7be34';
import { PAUSA } from './pausa.mjs?v=1b7be34';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
