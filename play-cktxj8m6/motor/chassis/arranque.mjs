...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=f64190d-SUCIO';
import { PAUSA } from './pausa.mjs?v=f64190d-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
