...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=77712da';
import { PAUSA } from './pausa.mjs?v=77712da';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
