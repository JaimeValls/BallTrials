...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=e4f53ed-SUCIO';
import { PAUSA } from './pausa.mjs?v=e4f53ed-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
