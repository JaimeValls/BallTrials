...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=02c0386';
import { PAUSA } from './pausa.mjs?v=02c0386';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
