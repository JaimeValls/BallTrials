...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=8d3d10a-SUCIO';
import { PAUSA } from './pausa.mjs?v=8d3d10a-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
