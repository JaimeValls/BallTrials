...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=7011ad7';
import { PAUSA } from './pausa.mjs?v=7011ad7';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
