...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=bdafefb';
import { PAUSA } from './pausa.mjs?v=bdafefb';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
