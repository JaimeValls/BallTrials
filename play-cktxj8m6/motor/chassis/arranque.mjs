...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=09a6e6b';
import { PAUSA } from './pausa.mjs?v=09a6e6b';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
