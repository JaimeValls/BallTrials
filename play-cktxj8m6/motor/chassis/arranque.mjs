...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=50cee4e';
import { PAUSA } from './pausa.mjs?v=50cee4e';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
