...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=eb591dd';
import { PAUSA } from './pausa.mjs?v=eb591dd';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
