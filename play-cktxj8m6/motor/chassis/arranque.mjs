...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=f84dd55';
import { PAUSA } from './pausa.mjs?v=f84dd55';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
