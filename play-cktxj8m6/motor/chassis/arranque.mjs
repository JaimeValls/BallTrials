...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=a16b169';
import { PAUSA } from './pausa.mjs?v=a16b169';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
