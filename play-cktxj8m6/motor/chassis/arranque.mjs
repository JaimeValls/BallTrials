...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=5acdb92';
import { PAUSA } from './pausa.mjs?v=5acdb92';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
