...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=663c9be';
import { PAUSA } from './pausa.mjs?v=663c9be';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
