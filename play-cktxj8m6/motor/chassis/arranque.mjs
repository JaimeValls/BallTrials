...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=63de6c1';
import { PAUSA } from './pausa.mjs?v=63de6c1';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
