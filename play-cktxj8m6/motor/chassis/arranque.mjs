...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=ad10556';
import { PAUSA } from './pausa.mjs?v=ad10556';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
