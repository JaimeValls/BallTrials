...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=65b4369';
import { PAUSA } from './pausa.mjs?v=65b4369';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
