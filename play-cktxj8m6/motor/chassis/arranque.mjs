...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=042f69e';
import { PAUSA } from './pausa.mjs?v=042f69e';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
