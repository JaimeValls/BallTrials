...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=8e2eab0';
import { PAUSA } from './pausa.mjs?v=8e2eab0';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
