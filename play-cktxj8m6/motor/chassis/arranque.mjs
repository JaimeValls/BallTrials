...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=ee0aaa6';
import { PAUSA } from './pausa.mjs?v=ee0aaa6';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
