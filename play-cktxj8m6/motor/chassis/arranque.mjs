...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=ababf72-SUCIO';
import { PAUSA } from './pausa.mjs?v=ababf72-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
