...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=1da222b';
import { PAUSA } from './pausa.mjs?v=1da222b';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
