...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=f83bb49';
import { PAUSA } from './pausa.mjs?v=f83bb49';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
