...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=39079c3';
import { PAUSA } from './pausa.mjs?v=39079c3';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
