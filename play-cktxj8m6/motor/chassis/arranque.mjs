...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=d07d215';
import { PAUSA } from './pausa.mjs?v=d07d215';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
