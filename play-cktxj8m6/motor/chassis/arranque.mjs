...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=13a794a';
import { PAUSA } from './pausa.mjs?v=13a794a';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
