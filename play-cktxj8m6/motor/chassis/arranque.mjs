...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=6bea86e';
import { PAUSA } from './pausa.mjs?v=6bea86e';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
