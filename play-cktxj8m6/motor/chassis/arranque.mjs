...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=227bccc-SUCIO';
import { PAUSA } from './pausa.mjs?v=227bccc-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
