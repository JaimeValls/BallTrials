...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=2928e1a';
import { PAUSA } from './pausa.mjs?v=2928e1a';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
