...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=17fbbac';
import { PAUSA } from './pausa.mjs?v=17fbbac';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
