...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=ca3ebb7';
import { PAUSA } from './pausa.mjs?v=ca3ebb7';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
