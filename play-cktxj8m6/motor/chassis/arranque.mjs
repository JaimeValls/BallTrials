...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=2abc472';
import { PAUSA } from './pausa.mjs?v=2abc472';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
