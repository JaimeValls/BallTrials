...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=3f6a5c4';
import { PAUSA } from './pausa.mjs?v=3f6a5c4';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
