...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=b80e764';
import { PAUSA } from './pausa.mjs?v=b80e764';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
