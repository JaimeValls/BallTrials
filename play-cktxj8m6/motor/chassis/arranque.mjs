...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=a8591c0';
import { PAUSA } from './pausa.mjs?v=a8591c0';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
