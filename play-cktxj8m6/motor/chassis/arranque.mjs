...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=dc9d000';
import { PAUSA } from './pausa.mjs?v=dc9d000';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
