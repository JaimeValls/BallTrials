...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=57a0c91';
import { PAUSA } from './pausa.mjs?v=57a0c91';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
