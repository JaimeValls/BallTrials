...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=0a52a34';
import { PAUSA } from './pausa.mjs?v=0a52a34';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
