...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=be8192a';
import { PAUSA } from './pausa.mjs?v=be8192a';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
