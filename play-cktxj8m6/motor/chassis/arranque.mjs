...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=5d37c9e';
import { PAUSA } from './pausa.mjs?v=5d37c9e';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
