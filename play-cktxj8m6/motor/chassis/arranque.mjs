...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=b51eaf3';
import { PAUSA } from './pausa.mjs?v=b51eaf3';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
