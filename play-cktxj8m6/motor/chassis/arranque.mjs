...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=1c6d87d-SUCIO';
import { PAUSA } from './pausa.mjs?v=1c6d87d-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
