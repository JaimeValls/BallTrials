...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=2067a3e';
import { PAUSA } from './pausa.mjs?v=2067a3e';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
