...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=e236171';
import { PAUSA } from './pausa.mjs?v=e236171';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
