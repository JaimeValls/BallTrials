...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=285f086';
import { PAUSA } from './pausa.mjs?v=285f086';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
