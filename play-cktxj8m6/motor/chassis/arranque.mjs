...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=ae32416';
import { PAUSA } from './pausa.mjs?v=ae32416';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
