...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=2a79017';
import { PAUSA } from './pausa.mjs?v=2a79017';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
