...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=e491a9a';
import { PAUSA } from './pausa.mjs?v=e491a9a';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
