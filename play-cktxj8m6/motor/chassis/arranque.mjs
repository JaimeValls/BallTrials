...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=f74d8ee';
import { PAUSA } from './pausa.mjs?v=f74d8ee';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
