...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=974380b';
import { PAUSA } from './pausa.mjs?v=974380b';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
