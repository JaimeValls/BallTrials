...
import { createSynth, makeRng, peakGain } from './synth.mjs?v=deb26dc-SUCIO';
import { PAUSA } from './pausa.mjs?v=deb26dc-SUCIO';   //+AG "el mundo no se mueve": el cartel tampoco se auto-arranca (ver tick)
