...
// los audio.mjs existentes ("import { createSynth, makeRng } from '../chassis/audio.mjs?v=37af923'") siguen funcionando.
//   import { createSynth, makeRng } from '../chassis/synth.mjs?v=37af923';
