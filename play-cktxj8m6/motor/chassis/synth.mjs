...
// los audio.mjs existentes ("import { createSynth, makeRng } from '../chassis/audio.mjs?v=5a4eb82'") siguen funcionando.
//   import { createSynth, makeRng } from '../chassis/synth.mjs?v=5a4eb82';
