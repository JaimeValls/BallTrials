...
// los audio.mjs existentes ("import { createSynth, makeRng } from '../chassis/audio.mjs?v=deb26dc-SUCIO'") siguen funcionando.
//   import { createSynth, makeRng } from '../chassis/synth.mjs?v=deb26dc-SUCIO';
