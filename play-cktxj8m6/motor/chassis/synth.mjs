...
// los audio.mjs existentes ("import { createSynth, makeRng } from '../chassis/audio.mjs?v=82904ad'") siguen funcionando.
//   import { createSynth, makeRng } from '../chassis/synth.mjs?v=82904ad';
