...
// los audio.mjs existentes ("import { createSynth, makeRng } from '../chassis/audio.mjs?v=042f69e'") siguen funcionando.
//   import { createSynth, makeRng } from '../chassis/synth.mjs?v=042f69e';
