...
//     import { vivas } from './motor/chassis/vivas.mjs?v=edadccb';
...
import { makeBallVinyl } from './gfx.mjs?v=edadccb';
import { archLook } from './ballmat.mjs?v=edadccb';
import { archFace } from './facegen.mjs?v=edadccb';
import { attachSquash } from './squash.mjs?v=edadccb';
