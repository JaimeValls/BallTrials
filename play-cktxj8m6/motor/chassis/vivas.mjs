...
//     import { vivas } from './motor/chassis/vivas.mjs?v=81cccca';
...
import { makeBallVinyl } from './gfx.mjs?v=81cccca';
import { archLook } from './ballmat.mjs?v=81cccca';
import { archFace } from './facegen.mjs?v=81cccca';
import { attachSquash } from './squash.mjs?v=81cccca';
