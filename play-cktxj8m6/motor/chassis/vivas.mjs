...
//     import { vivas } from './motor/chassis/vivas.mjs?v=9ebbeab';
...
import { makeBallVinyl } from './gfx.mjs?v=9ebbeab';
import { archLook } from './ballmat.mjs?v=9ebbeab';
import { archFace } from './facegen.mjs?v=9ebbeab';
import { attachSquash } from './squash.mjs?v=9ebbeab';
