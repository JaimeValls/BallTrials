...
//     import { vivas } from './motor/chassis/vivas.mjs?v=f4e19ee';
...
import { makeBallVinyl } from './gfx.mjs?v=f4e19ee';
import { archLook } from './ballmat.mjs?v=f4e19ee';
import { archFace } from './facegen.mjs?v=f4e19ee';
import { attachSquash } from './squash.mjs?v=f4e19ee';
