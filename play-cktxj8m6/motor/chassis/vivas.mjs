...
//     import { vivas } from './motor/chassis/vivas.mjs?v=5a4eb82';
...
import { makeBallVinyl } from './gfx.mjs?v=5a4eb82';
import { archLook } from './ballmat.mjs?v=5a4eb82';
import { archFace } from './facegen.mjs?v=5a4eb82';
import { attachSquash } from './squash.mjs?v=5a4eb82';
