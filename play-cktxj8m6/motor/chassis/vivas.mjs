...
//     import { vivas } from './motor/chassis/vivas.mjs?v=50cee4e';
...
import { makeBallVinyl } from './gfx.mjs?v=50cee4e';
import { archLook } from './ballmat.mjs?v=50cee4e';
import { archFace } from './facegen.mjs?v=50cee4e';
import { attachSquash } from './squash.mjs?v=50cee4e';
