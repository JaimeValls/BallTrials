...
//     import { vivas } from './motor/chassis/vivas.mjs?v=037a45d';
...
import { makeBallVinyl } from './gfx.mjs?v=037a45d';
import { archLook } from './ballmat.mjs?v=037a45d';
import { archFace } from './facegen.mjs?v=037a45d';
import { attachSquash } from './squash.mjs?v=037a45d';
