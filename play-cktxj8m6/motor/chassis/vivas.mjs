...
//     import { vivas } from './motor/chassis/vivas.mjs?v=ade307c';
...
import { makeBallVinyl } from './gfx.mjs?v=ade307c';
import { archLook } from './ballmat.mjs?v=ade307c';
import { archFace } from './facegen.mjs?v=ade307c';
import { attachSquash } from './squash.mjs?v=ade307c';
