...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=95bdd8d-SUCIO';
import { geometriaCuerpo } from './silueta.mjs?v=95bdd8d-SUCIO';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=95bdd8d-SUCIO';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=95bdd8d-SUCIO';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=95bdd8d-SUCIO';   //+AG doc 41 bloque G: prop de la bola-heroe
...
export function createParticles(scene){
  ...
  return { emit, burst, ring, trail, update, get emitidas(){ return emitidas; } };
}
