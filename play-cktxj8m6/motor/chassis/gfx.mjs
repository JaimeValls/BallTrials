...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=2928e1a';
import { geometriaCuerpo } from './silueta.mjs?v=2928e1a';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=2928e1a';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=2928e1a';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=2928e1a';   //+AG doc 41 bloque G: prop de la bola-heroe
