...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=b51eaf3';
import { geometriaCuerpo } from './silueta.mjs?v=b51eaf3';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=b51eaf3';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=b51eaf3';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=b51eaf3';   //+AG doc 41 bloque G: prop de la bola-heroe
