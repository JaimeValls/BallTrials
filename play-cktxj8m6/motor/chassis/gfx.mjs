...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=deb26dc-SUCIO';
import { geometriaCuerpo } from './silueta.mjs?v=deb26dc-SUCIO';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=deb26dc-SUCIO';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=deb26dc-SUCIO';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=deb26dc-SUCIO';   //+AG doc 41 bloque G: prop de la bola-heroe
