...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=d17deb4';
import { geometriaCuerpo } from './silueta.mjs?v=d17deb4';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=d17deb4';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=d17deb4';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=d17deb4';   //+AG doc 41 bloque G: prop de la bola-heroe
