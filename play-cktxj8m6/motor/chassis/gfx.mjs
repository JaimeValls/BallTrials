...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=edadccb';
import { geometriaCuerpo } from './silueta.mjs?v=edadccb';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=edadccb';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=edadccb';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=edadccb';   //+AG doc 41 bloque G: prop de la bola-heroe
