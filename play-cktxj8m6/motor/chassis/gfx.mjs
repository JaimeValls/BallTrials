...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=ca14cba';
import { geometriaCuerpo } from './silueta.mjs?v=ca14cba';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=ca14cba';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=ca14cba';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=ca14cba';   //+AG doc 41 bloque G: prop de la bola-heroe
