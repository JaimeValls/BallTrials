...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=eb591dd';
import { geometriaCuerpo } from './silueta.mjs?v=eb591dd';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=eb591dd';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=eb591dd';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=eb591dd';   //+AG doc 41 bloque G: prop de la bola-heroe
