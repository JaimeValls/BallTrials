...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=ade307c';
import { geometriaCuerpo } from './silueta.mjs?v=ade307c';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=ade307c';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=ade307c';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=ade307c';   //+AG doc 41 bloque G: prop de la bola-heroe
