...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=f4e19ee';
import { geometriaCuerpo } from './silueta.mjs?v=f4e19ee';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=f4e19ee';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=f4e19ee';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=f4e19ee';   //+AG doc 41 bloque G: prop de la bola-heroe
