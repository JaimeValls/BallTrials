...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=bdafefb';
import { geometriaCuerpo } from './silueta.mjs?v=bdafefb';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=bdafefb';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=bdafefb';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=bdafefb';   //+AG doc 41 bloque G: prop de la bola-heroe
