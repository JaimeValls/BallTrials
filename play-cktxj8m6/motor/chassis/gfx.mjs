...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=b8175e7';
import { geometriaCuerpo } from './silueta.mjs?v=b8175e7';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=b8175e7';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=b8175e7';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=b8175e7';   //+AG doc 41 bloque G: prop de la bola-heroe
