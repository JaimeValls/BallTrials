...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=05e5c3d';
import { geometriaCuerpo } from './silueta.mjs?v=05e5c3d';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=05e5c3d';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=05e5c3d';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=05e5c3d';   //+AG doc 41 bloque G: prop de la bola-heroe
