...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=da5637b';
import { geometriaCuerpo } from './silueta.mjs?v=da5637b';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=da5637b';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=da5637b';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=da5637b';   //+AG doc 41 bloque G: prop de la bola-heroe
