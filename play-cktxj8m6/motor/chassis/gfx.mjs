...
import { faceTexture, hunterTexture, faceLayers, bareExpr, PRESETS as FACE_PRESETS } from './facegen.mjs?v=d84768d';
import { geometriaCuerpo } from './silueta.mjs?v=d84768d';   //+AG doc 55 capa 1: cuerpos que no son esferas
...
import { itemTexture } from './itemgen.mjs?v=d84768d';
import { ballMaterial, skinTexture } from './ballmat.mjs?v=d84768d';   //+AG skinTexture: la piel del cuerpo (encargo 17)
import { makeProp } from './propgen.mjs?v=d84768d';   //+AG doc 41 bloque G: prop de la bola-heroe
