...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=a8591c0';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=a8591c0';
import { createFx } from '../chassis/sfx.mjs?v=a8591c0';
import { FPS } from './sim.js?v=a8591c0';
