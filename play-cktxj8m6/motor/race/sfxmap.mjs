...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=eb591dd';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=eb591dd';
import { createFx } from '../chassis/sfx.mjs?v=eb591dd';
import { FPS } from './sim.js?v=eb591dd';
