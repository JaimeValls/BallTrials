...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=8d3d10a-SUCIO';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=8d3d10a-SUCIO';
import { createFx } from '../chassis/sfx.mjs?v=8d3d10a-SUCIO';
import { FPS } from './sim.js?v=8d3d10a-SUCIO';
