...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=96ca7c9';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=96ca7c9';
import { createFx } from '../chassis/sfx.mjs?v=96ca7c9';
import { FPS } from './sim.js?v=96ca7c9';
