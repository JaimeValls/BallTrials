...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=cfc5692';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=cfc5692';
import { createFx } from '../chassis/sfx.mjs?v=cfc5692';
import { FPS } from './sim.js?v=cfc5692';
