...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=b8175e7';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=b8175e7';
import { createFx } from '../chassis/sfx.mjs?v=b8175e7';
import { FPS } from './sim.js?v=b8175e7';
