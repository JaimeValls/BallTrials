...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=81cccca';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=81cccca';
import { createFx } from '../chassis/sfx.mjs?v=81cccca';
import { FPS } from './sim.js?v=81cccca';
