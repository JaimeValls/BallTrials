...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=cb18883';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=cb18883';
import { createFx } from '../chassis/sfx.mjs?v=cb18883';
import { FPS } from './sim.js?v=cb18883';
