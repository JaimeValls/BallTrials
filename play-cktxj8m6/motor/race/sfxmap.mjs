...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=f55ae74';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=f55ae74';
import { createFx } from '../chassis/sfx.mjs?v=f55ae74';
import { FPS } from './sim.js?v=f55ae74';
