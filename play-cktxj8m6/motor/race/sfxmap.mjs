...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=f64190d-SUCIO';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=f64190d-SUCIO';
import { createFx } from '../chassis/sfx.mjs?v=f64190d-SUCIO';
import { FPS } from './sim.js?v=f64190d-SUCIO';
