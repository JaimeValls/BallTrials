...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=00946e1';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=00946e1';
import { createFx } from '../chassis/sfx.mjs?v=00946e1';
import { FPS } from './sim.js?v=00946e1';
