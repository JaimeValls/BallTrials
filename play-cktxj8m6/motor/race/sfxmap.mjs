...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=bdafefb';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=bdafefb';
import { createFx } from '../chassis/sfx.mjs?v=bdafefb';
import { FPS } from './sim.js?v=bdafefb';
