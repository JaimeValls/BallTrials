...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=65b4369';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=65b4369';
import { createFx } from '../chassis/sfx.mjs?v=65b4369';
import { FPS } from './sim.js?v=65b4369';
