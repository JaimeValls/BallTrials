...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=b812e3b';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=b812e3b';
import { createFx } from '../chassis/sfx.mjs?v=b812e3b';
import { FPS } from './sim.js?v=b812e3b';
