...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=ce0c08b';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=ce0c08b';
import { createFx } from '../chassis/sfx.mjs?v=ce0c08b';
import { FPS } from './sim.js?v=ce0c08b';
