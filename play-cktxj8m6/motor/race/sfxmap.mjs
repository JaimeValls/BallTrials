...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=1b7be34';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=1b7be34';
import { createFx } from '../chassis/sfx.mjs?v=1b7be34';
import { FPS } from './sim.js?v=1b7be34';
