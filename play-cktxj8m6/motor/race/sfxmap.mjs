...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=39079c3';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=39079c3';
import { createFx } from '../chassis/sfx.mjs?v=39079c3';
import { FPS } from './sim.js?v=39079c3';
