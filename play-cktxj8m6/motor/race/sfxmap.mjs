...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=ac3c8c1-SUCIO';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=ac3c8c1-SUCIO';
import { createFx } from '../chassis/sfx.mjs?v=ac3c8c1-SUCIO';
import { FPS } from './sim.js?v=ac3c8c1-SUCIO';
