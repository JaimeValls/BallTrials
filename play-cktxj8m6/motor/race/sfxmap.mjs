...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=f4e19ee';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=f4e19ee';
import { createFx } from '../chassis/sfx.mjs?v=f4e19ee';
import { FPS } from './sim.js?v=f4e19ee';
