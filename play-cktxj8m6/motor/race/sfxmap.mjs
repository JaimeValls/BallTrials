...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=a16b169';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=a16b169';
import { createFx } from '../chassis/sfx.mjs?v=a16b169';
import { FPS } from './sim.js?v=a16b169';
