...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=62f566e';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=62f566e';
import { createFx } from '../chassis/sfx.mjs?v=62f566e';
import { FPS } from './sim.js?v=62f566e';
