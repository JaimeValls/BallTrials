...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=63de6c1';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=63de6c1';
import { createFx } from '../chassis/sfx.mjs?v=63de6c1';
import { FPS } from './sim.js?v=63de6c1';
