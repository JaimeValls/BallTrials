...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=e236171';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=e236171';
import { createFx } from '../chassis/sfx.mjs?v=e236171';
import { FPS } from './sim.js?v=e236171';
