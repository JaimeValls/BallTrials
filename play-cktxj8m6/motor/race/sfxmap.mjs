...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=ab3d86c';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=ab3d86c';
import { createFx } from '../chassis/sfx.mjs?v=ab3d86c';
import { FPS } from './sim.js?v=ab3d86c';
