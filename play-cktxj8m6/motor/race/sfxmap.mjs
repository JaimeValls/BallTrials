...
//   import { buildSfxBuffer } from './sfxmap.mjs?v=f83bb49';
//   const buf = buildSfxBuffer({ events, decision_frame, f, seed, SR });   // Float32Array mono (sin normalizar)
import { createSynth, makeRng } from '../chassis/synth.mjs?v=f83bb49';
import { createFx } from '../chassis/sfx.mjs?v=f83bb49';
import { FPS } from './sim.js?v=f83bb49';
